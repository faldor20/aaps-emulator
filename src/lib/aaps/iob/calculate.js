 ...
 * @property {Date} date - The date of the treatment
 * @property {number} insulin - The amount of insulin administered
 */

/**
 * @typedef {Object} Profile
 * @property {number} dia - Duration of insulin action in hours
 * @property {number} peak - Time of peak insulin activity in minutes
 ...
 * @returns 
 */
export function iobCalc(treatment, time, curve, dia, peak, profile) {
